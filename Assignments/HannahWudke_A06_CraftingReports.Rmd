...
|     Item | Value                          |
|---------:|:-------------------------------|
| Filename | EPAair_O3_NC1819_Processed.csv |
|     Date | 2018-2019                      |
...
```{r echo=FALSE, warning=FALSE, fig.height = 4, fig.width = 5, fig.align='left', fig.cap="Boxplot: 2019 Ozone"}
# months to factors 
epa_months <- as.factor(epa_data$Month)

ggplot(subset(epa_data, Year == '2018'), aes(x = Month, y = Ozone, shape = as.factor(Month))) + geom_boxplot()

```

```{r echo=FALSE, warning=FALSE, fig.height = 4, fig.width = 5, fig.align='left', fig.cap="Boxplot: 2019 Ozone"}

ggplot(subset(epa_data, Year == '2019'), aes(x = Month, y = Ozone, shape = as.factor(Month))) + geom_boxplot()

```

```{r echo=FALSE, warning=FALSE, fig.height = 4, fig.width = 5, fig.align='left', fig.cap="Boxplot: 2018 PM2.5"}

ggplot(subset(epa_data, Year == '2018'), aes(x = Month, y = PM2.5, shape = as.factor(Month))) + geom_boxplot()

```

```{r echo=FALSE, warning=FALSE, fig.height = 4, fig.width = 5, fig.align='left', fig.cap="Boxplot: 2019 PM2.5"}

ggplot(subset(epa_data, Year == '2019'), aes(x = Month, y = PM2.5, shape = as.factor(Month))) + geom_boxplot()
...
[myGitHub](https://github.com/h-wud/EDE_Fall2024)
